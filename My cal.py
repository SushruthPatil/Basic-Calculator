...
metext=Entry(me,font=("Courier New",15,'bold'),textvar=textin,width=21,bd=7,bg='powder blue')
metext.pack()
...
but0=Button(me,padx=47,pady=14,bd=4,bg='white',command=lambda:clickbut(0),text="0",font=("Courier New",16,'bold'))
